...
const config = {
  ...
  themeConfig:
    ...
    ({
      announcementBar: {
        id: 'announcement-nbomber-studio-0.8.2',
        content: '🚀 NBomber Studio 0.8.2 <a href="https://nbomber.com/blog/2026/07/10/nbomber-studio-0.8.2" target="_blank">released</a>!',
