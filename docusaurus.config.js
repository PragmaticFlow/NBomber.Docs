...
const config = {
  ...
  themeConfig:
    ...
    ({
      announcementBar: {
        id: 'announcement-nbomber-studio-0.8.0',
        content: '🚀 NBomber Studio 0.8.0 <a href="https://nbomber.com/blog/2026/06/19/nbomber-studio-0.8.0" target="_blank">released</a>!',
