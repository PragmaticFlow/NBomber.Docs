...
const config = {
  ...
  themeConfig:
    ...
    ({
      announcementBar: {
        id: 'announcement-nbomber-studio-0.7.1',
        content: '🚀 NBomber Studio 0.7.1 <a href="https://nbomber.com/blog/2026/05/18/nbomber-studio-v0.7.1" target="_blank">released</a>!',
