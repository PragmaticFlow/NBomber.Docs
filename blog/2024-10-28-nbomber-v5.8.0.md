...
import LatencyStepImage from './img/v5.8/latency-indicators-step.jpg';
import LatencyScenarioImage from './img/v5.8/latency-indicators-scenario.jpg';
...
<center><img src={LatencyScenarioImage} width="80%" height="80%" /></center>

Example: Step latency indicators panel.

<center><img src={LatencyStepImage} width="80%" height="80%" /></center>
