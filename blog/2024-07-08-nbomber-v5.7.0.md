...
For specific scenarios, it can be helpful to control the session-id fully. Now you can pass your custom session-id via F#/C# API or [CLI args](https://nbomber.com/docs/nbomber/cli).
