...
NBomber Studio currently supports two project types:

- [**C# Script**](csharp-script) — best suited for simple load tests, demos, and dry runs where you want to test a few endpoints or a single microservice and get quick results. The main benefit is that you can change the code on the fly without recompiling your scenario, which makes it ideal for trying out NBomber and iterating quickly.
