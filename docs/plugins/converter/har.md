...
Below are the essential steps to follow for recording HAR in Chrome ([you can watch this video](https://youtu.be/VUqUbPs_dD0)):
...
## Run Converter
Use `nb-converter` command to parse HAR file and convert to NBomber Scenario:
```
